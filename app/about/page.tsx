...
export default function About() {
	const experienceCount = WORK_EXPERIENCE.length - 1;
	const lastExperience = WORK_EXPERIENCE[experienceCount];
	return (
		<div className="flex">
			<div className="sm:w-1/2 w-full">
				...
				<h2 className="text-sm sm:text-base mt-1 sm:mt-2">
					<b>
						Archit is a {lastExperience.title} at {lastExperience.company} since{" "}
						{lastExperience.duration.split("-")[0].trim()}
					</b>
					.
					<br />
					Over the past decade, he has demonstrated his expertise through
					diverse engineering roles at different organizations like{" "}
					{WORK_EXPERIENCE.slice(experienceCount - 3, experienceCount)
						.map((exp) => exp.company)
						.join(", ")}{" "}
					as well as through successful completion of numerous freelance
					projects and OSS contributions. Before moving to Canada, he pursued
					his academic endeavors in Computer Science at VIT University, India.
					His formative years were spent in a small town in northern India,
					where his fascination with Computer Science began. When he is not
					working, he loves playing guitar, doing yoga, meditation, poetry and
					reading.
				</h2>
